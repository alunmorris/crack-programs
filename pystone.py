...
Version:        Python/1.2.1 (corresponds to C/1.1 plus 3 Pystone fixes)
...
Version History:
                ...
                Version 1.2.1 (Alun Morris) does not import clock for, for Micropython 1.2.4 (ESP32) compatibility
...
import utime
_clock_t0 = utime.ticks_ms()
def clock():
    return utime.ticks_diff(utime.ticks_ms(), _clock_t0) / 1000
